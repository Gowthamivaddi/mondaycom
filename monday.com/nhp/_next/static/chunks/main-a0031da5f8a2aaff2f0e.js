    ...
    [59], {
        ...
        IKlv: function(e, t, r) {
            ...
            var k = function(e) {
                ...
                W = N.defaultLocale,
                U = D || "";
            r.p = "".concat(U, "/_next/"), _.setConfig({
                serverRuntimeConfig: {},
                publicRuntimeConfig: j || {}
            });
            var V = (0, x.getURL)();
            (0, S.hasBasePath)(V) && (V = (0, S.delBasePath)(V));
            var K = new P.default(I, U),
                Y = function(e) {
                    var t = l(e, 2),
                        r = t[0],
                        n = t[1];
            ...
            var te, re = function(e) {
                    ...
                    return i(r, [{
                        ...
                        value: function() {
                            this.scrollToHash(), z.isSsr && (O || N.nextExport && ((0, w.isDynamicRoute)(z.pathname) || location.search) || M && M.__N_SSG && location.search) && z.replace(z.pathname + "?" + String(E.assign(E.urlQueryToSearchParams(z.query), new URLSearchParams(location.search))), V, {
                                _h: 1,
                                shallow: !O
                            })
                        }
                ...
                var e = o(n.mark((function e() {
                    ...
                    return n.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 36:
                                return t.router = z = (0, A.createRouter)(L, F, V, {
                                    initialProps: M,
                                    pageLoader: K,
                                    App: Q,
                                    Component: te,
            ...
            function ie() {
                return (ie = o(n.mark((function e(t) {
                    return n.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                if (!t.err) {
            ...
            function ue(e) {
                var t = e.App,
                    r = e.err;
                return console.error(r), K.loadPage("/_error").then((function(n) {
                    var o = n.page,
                        a = n.styleSheets,
                        i = me(t),
                        u = {
...
//# sourceMappingURL=main-a0031da5f8a2aaff2f0e.js.map